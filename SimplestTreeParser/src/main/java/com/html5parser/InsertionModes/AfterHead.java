...
public class AfterHead {
	...
	public void TokenAnythingElse(Document doc,Token token, TreeConstructor treeConstructor, boolean reprocessToken) {
	...
	private void TokenEndTag(Document doc, Token token,
		...
		if (token.getValue().equals("head") || token.getValue().equals("body")
			...
			.push(token.getValue() + " close tag in InHead insertion mode");
		}
	}
